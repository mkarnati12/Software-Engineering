...
class Level(BaseLevel):
    ...
    def spawn_player(self,index):
        if index == 0:
            return PlayerGroup(not self.auto_play,"./assets/ninja1.png", STEP_DISTANCE, STEP_DISTANCE)
        if index == 1:
            return PlayerGroup(False,"./assets/ninja4.png", STEP_DISTANCE*self.x_length, STEP_DISTANCE*self.y_length)
        if index == 2:
            return PlayerGroup(False,"./assets/ninja2.png", STEP_DISTANCE, STEP_DISTANCE*self.y_length)
        if index == 3:
            return PlayerGroup(False,"./assets/ninja3.png", STEP_DISTANCE*self.x_length, STEP_DISTANCE)
